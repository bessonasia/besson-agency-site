...
const I18N = {
  ru: {
    ...
    aboutText: "Мы создаем яркие концепции для мероприятий и бренд-активаций, организуем маркетинговые и корпоративные события. Реализуем BTL-проекты и усиливаем бренды через продуманные коммуникации.",
	    resourcesTitle: "Ресурсы",
	    resourcesAria: "Ресурсы агентства",
	    resourcesUpTo: "до",
	    resourcesLegalOffices: "Офиса и юридические лица в Евразии",
	    resourcesCredit: "Кредитуем проекты на срок до 90 календарных дней и сумму до 200 000$",
    ...
    howKicker: "Экспозиция · Процесс · 5 этапов",
    howTitle: "Как мы работаем",
    howStage: "Этап",
    how01: "Бриф",
    how01Text: "Собираем вводные, цели, ограничения и критерии успеха.",
    how02: "Концепция",
    how02Text: "Делаем идею и структуру, которая держит внимание и цель.",
    how03: "Подготовка",
    how03Text: "Смета, команда, план-график, контроль рисков и качества.",
    how04: "Реализация",
    how04Text: "Ведем процесс в день Х: темп, точность, управление сценарием.",
    how05: "Отчет",
    how05Text: "Финализация, документы, выводы и улучшения на следующий цикл.",
    ...
    close: "Закрыть",
    docsLabel: "Тендерные документы",
    docsHint: "PDF / DOCX / ZIP до 50MB",
    attach: "Прикрепить",
    noDocs: "Документов нет",
    docsStepHint: "Можно прикрепить документы или отметить \"Документов нет\".",
    docsNotice: "Тендерные документы можно прикрепить на последнем шаге. PDF / DOCX / ZIP до 50MB.",
    continue: "Продолжить",
    submit: "Отправить",
    back: "Назад",
    success: "Приступаем к проекту",
    ...
    fileTooLarge: "Слишком большой файл. Максимум 50MB",
	    ...
	    workSwitchKicker: "Выберите тип проекта",
	    newsKicker: "Новости",
    ...
    marketingConsentPrefix: "Согласен получать рекламные и информационные сообщения.",
    ...
    aboutText: "We create vivid concepts for events and brand activations, organize marketing and corporate experiences, deliver BTL projects, and strengthen brands through thoughtful communications.",
	    resourcesTitle: "Resources",
	    resourcesAria: "Agency resources",
	    resourcesUpTo: "up to",
	    resourcesLegalOffices: "Offices and legal entities in Eurasia",
	    resourcesCredit: "We can credit projects for up to 90 calendar days and up to $200,000",
    ...
    howKicker: "Exhibition · Process · 5 stages",
    howTitle: "How we work",
    howStage: "Stage",
    how01: "Brief",
    how01Text: "We collect inputs, goals, constraints, and success criteria.",
    how02: "Concept",
    how02Text: "We build an idea and structure that hold attention and serve the goal.",
    how03: "Preparation",
    how03Text: "Budget, team, schedule, risk control, and quality control.",
    how04: "Delivery",
    how04Text: "We run the day itself: pace, precision, and scenario management.",
    how05: "Report",
    how05Text: "Finalization, documents, conclusions, and improvements for the next cycle.",
    ...
    close: "Close",
    docsLabel: "Tender documents",
    docsHint: "PDF / DOCX / ZIP up to 50MB",
    attach: "Attach",
    noDocs: "No documents",
    docsStepHint: "Attach documents or mark \"No documents\".",
    docsNotice: "Tender documents can be attached at the last step. PDF / DOCX / ZIP up to 50MB.",
    continue: "Continue",
    submit: "Submit",
    back: "Back",
    success: "Starting the project",
    ...
    fileTooLarge: "File is too large. Maximum 50MB",
	    ...
	    workSwitchKicker: "Choose project type",
	    newsKicker: "News",
    ...
    marketingConsentPrefix: "I agree to receive marketing and informational messages.",
    ...
    aboutText: "Biz tadbirlar va brend aktivatsiyalari uchun yorqin konsepsiyalar yaratamiz, marketing va korporativ tadbirlarni tashkil qilamiz. BTL-loyihalarni amalga oshiramiz va puxta kommunikatsiyalar orqali brendlarni kuchaytiramiz.",
	    resourcesTitle: "Resurslar",
	    resourcesAria: "Agentlik resurslari",
	    resourcesUpTo: "gacha",
	    resourcesLegalOffices: "Yevrosiyoda ofislar va yuridik shaxslar",
	    resourcesCredit: "Loyihalarni 90 kalendar kungacha va 200 000$ gacha moliyalashtiramiz",
    ...
    howKicker: "Ekspozitsiya · Jarayon · 5 bosqich",
    howTitle: "Biz qanday ishlaymiz",
    howStage: "Bosqich",
    how01: "Brif",
    how01Text: "Kirish ma'lumotlari, maqsadlar, cheklovlar va muvaffaqiyat mezonlarini yig‘amiz.",
    how02: "Konsepsiya",
    how02Text: "E'tibor va maqsadni ushlab turadigan g‘oya hamda tuzilmani yaratamiz.",
    how03: "Tayyorgarlik",
    how03Text: "Smeta, jamoa, jadval, risk va sifat nazorati.",
    how04: "Amalga oshirish",
    how04Text: "Tadbir kuni jarayonni boshqaramiz: temp, aniqlik va ssenariy nazorati.",
    how05: "Hisobot",
    how05Text: "Yakunlash, hujjatlar, xulosalar va keyingi sikl uchun yaxshilanishlar.",
    ...
    close: "Yopish",
    docsLabel: "Tender hujjatlari",
    docsHint: "PDF / DOCX / ZIP 50MB gacha",
    attach: "Biriktirish",
    noDocs: "Hujjatlar yo‘q",
    docsStepHint: "Hujjatlarni biriktiring yoki \"Hujjatlar yo‘q\" deb belgilang.",
    docsNotice: "Tender hujjatlarini oxirgi bosqichda biriktirish mumkin. PDF / DOCX / ZIP 50MB gacha.",
    continue: "Davom etish",
    submit: "Yuborish",
    back: "Orqaga",
    success: "Loyihani boshlaymiz",
    ...
    fileTooLarge: "Fayl juda katta. Maksimum 50MB",
	    ...
	    workSwitchKicker: "Loyiha turini tanlang",
    ...
    marketingConsentPrefix: "Marketing va axborot xabarlarini olishga roziman.",
    ...
    aboutText: "Біз іс-шаралар мен бренд-активациялар үшін жарқын концепциялар жасаймыз, маркетингтік және корпоративтік оқиғаларды ұйымдастырамыз. BTL-жобаларды іске асырып, ойластырылған коммуникациялар арқылы брендтерді күшейтеміз.",
	    resourcesTitle: "Ресурстар",
	    resourcesAria: "Агенттік ресурстары",
	    resourcesUpTo: "дейін",
	    resourcesLegalOffices: "Еуразиядағы кеңселер мен заңды тұлғалар",
	    resourcesCredit: "Жобаларды 90 күнтізбелік күнге дейін және 200 000$ дейін қаржыландырамыз",
    ...
    howKicker: "Экспозиция · Процесс · 5 кезең",
    howTitle: "Қалай жұмыс істейміз",
    howStage: "Кезең",
    how01: "Бриф",
    how01Text: "Кіріс деректерін, мақсаттарды, шектеулерді және табыс критерийлерін жинаймыз.",
    how02: "Концепция",
    how02Text: "Назарды және мақсатты ұстайтын идея мен құрылымды жасаймыз.",
    how03: "Дайындық",
    how03Text: "Смета, команда, жоспар-кесте, тәуекел және сапа бақылауы.",
    how04: "Іске асыру",
    how04Text: "Іс-шара күнін жүргіземіз: қарқын, дәлдік және сценарийді басқару.",
    how05: "Есеп",
    how05Text: "Қорытындылау, құжаттар, тұжырымдар және келесі циклге жақсартулар.",
    ...
    close: "Жабу",
    docsLabel: "Тендерлік құжаттар",
    docsHint: "PDF / DOCX / ZIP 50MB дейін",
    attach: "Тіркеу",
    noDocs: "Құжаттар жоқ",
    docsStepHint: "Құжаттарды тіркеңіз немесе \"Құжаттар жоқ\" деп белгілеңіз.",
    docsNotice: "Тендерлік құжаттарды соңғы қадамда тіркеуге болады. PDF / DOCX / ZIP 50MB дейін.",
    continue: "Жалғастыру",
    submit: "Жіберу",
    back: "Артқа",
    success: "Жобаны бастаймыз",
    ...
    fileTooLarge: "Файл тым үлкен. Максимум 50MB",
	    ...
	    workSwitchKicker: "Жоба түрін таңдаңыз",
    ...
    marketingConsentPrefix: "Жарнамалық және ақпараттық хабарламалар алуға келісемін.",
...
let currentLang = "ru";
const tr = (key) => (I18N[currentLang] && I18N[currentLang][key]) || I18N.ru[key] || key;
...
const formatResourceNumber = (value) => new Intl.NumberFormat(currentLang === "en" ? "en-US" : "ru-RU", {
...
function applyTranslations(lang = currentLang) {
  ...
  qsa(".lang__btn").forEach((btn) => {
    ...
    btn.setAttribute("aria-pressed", active ? "true" : "false");
	  ...
	  setTextAll('.nav__group a[href="#about"], #mobileMenu a[href="#about"]', tr("navAbout"));
	  setTextAll('.nav__group a[href="#work"], #mobileMenu a[href="#work"]', tr("navWork"));
	  setTextAll('.nav__group a[href="#news"], #mobileMenu a[href="#news"]', tr("navNews"));
	  setTextAll('.nav__group a[href="#contact"], #mobileMenu a[href="#contact"]', tr("navContact"));
  ...
  qsa("[data-resource-card]").forEach((card) => {
    ...
    const text = qs(".resource-card__text", card);
    ...
    if (value && card.dataset.counted === "1") value.textContent = formatResourceNumber(Number(card.dataset.target || 0));
    if (text) text.textContent = tr(text.dataset.resourceText);
  });
  ...
  if (cookieText) cookieText.innerHTML = `${tr("cookieText")} <a href="privacy.html" target="_blank" rel="noopener">${tr("privacyPolicy")}</a>.`;
...
function initLanguageSwitch() {
  ...
  qsa(".lang__btn").forEach((btn) => {
    btn.addEventListener("click", () => applyTranslations(btn.dataset.lang || "ru"));
  });
...
function initResources() {
  ...
  const paintValue = (card, value) => {
    ...
    if (output) output.textContent = formatResourceNumber(value);
  };
  ...
  const countCard = (card) => {
    ...
    if (prefersReduced) {
      ...
      return;
	    ...
	    const duration = target === 3 ? 2450 : (target > 1000 ? 1885 : 1365);
...
function initTeam() {
  const rail = qs("#teamRail");
  const dotsWrap = qs("#teamDots");
  if (!rail || !dotsWrap) return;

  const btnPrev = qs("[data-team-prev]");
  const btnNext = qs("[data-team-next]");
  const cards = qsa(".team-card", rail);
  ...
  const dots = cards.map((_, index) => {
    ...
    button.className = "team-dot";
    button.type = "button";
    button.setAttribute("aria-label", `Показать сотрудника ${index + 1}`);
    dotsWrap.appendChild(button);
    return button;
  });

  const getStep = () => {
    const currentCards = qsa(".team-card", rail);
    return currentCards.length > 1 ? currentCards[1].offsetLeft - currentCards[0].offsetLeft : 280;
  };
  const getIndex = () => Math.max(0, Math.min(count - 1, Math.round(rail.scrollLeft / Math.max(1, getStep()))));
  const setActiveDot = (index) => dots.forEach((dot, i) => dot.classList.toggle("is-active", i === index));
  const scrollToIndex = (index) => {
    const safe = Math.max(0, Math.min(count - 1, index));
    rail.scrollTo({ left: safe * getStep(), behavior: "smooth" });
    setActiveDot(safe);
  };
  ...
  rail.addEventListener("scroll", () => requestAnimationFrame(() => setActiveDot(getIndex())), { passive: true });
  setActiveDot(0);

  const revealNodes = qsa(".team__kicker, .team__title, .team-card", qs("#team"));
...
function initCookieBanner() {
  ...
  const key = "besson_cookie_choice";
  let choice = "";
...
function initGlobeStrip() {
  ...
  const cities = [
    { name: "офис Алматы", lat: 31, lon: 20 },
    { name: "офис Москва", lat: 60, lon: -5 },
    { name: "офис Ташкент", lat: 32, lon: -10 },
  ].map((city) => {
  ...
  const DRAW_MS = prefersReduced ? 0 : 1450;
  const HOLD_MS = prefersReduced ? 1600 : 940;
  ...
  const updateLabel = (show) => {
    ...
    label.textContent = cities[active].name;
    label.style.left = `${(world.x * 0.5 + 0.5) * dome.clientWidth}px`;
    label.style.top = `${(-world.y * 0.5 + 0.5) * dome.clientHeight - 18}px`;
...
function initGlobeDomeScroll() {
  ...
  let raf = 0;
	  ...
	  const compute = () => {
	    ...
	    const isMobile = matchMedia("(max-width:768px)").matches;
	    const from = isMobile ? -7 : -15;
	    const to = isMobile ? 6 : 0;
